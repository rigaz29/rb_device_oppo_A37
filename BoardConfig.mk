...
# Tabel DT terpisah, bukan DTB yang ditempelkan kernel.
#
# Penempelan lewat CONFIG_BUILD_ARM64_APPENDED_DTB_IMAGE sudah dicoba dan
# DITOLAK bootloader: DTB benar-benar tertempel (magic d00dfeed persis di akhir
# Image) dan isinya cocok dengan perangkat -- msm-id ce/f8/f9/fa, board-id
# 08/00/3c27, sama persis dengan /proc/device-tree pada TWRP yang berjalan --
# tapi kernel tidak pernah dijalankan: /data tetap kosong (init belum pernah
# jalan) dan ramoops tidak memuat satu baris pun dari kernel ROM.
#
# Yang terbukti diterima LK di perangkat ini adalah tabel DT terpisah: partisi
# recovery TWRP yang jelas-jelas boot punya dt_size = 210944. dtbToolOppo
# menghasilkan tabel 210944 byte yang sama.
